...
ulang:
// function change(){
echo color("blue","                  Novarian Indra Setiawan\n");
...
echo color("white","                  Format Kode 62*** \n");
	...
	gocar:
        ...
        sleep(3);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"G-BJSJ4WK"}');
	...
	$post = [
         ...
         echo color("white","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN MU = 071101 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"071101"}';
