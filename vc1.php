...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"KEJUTANGOMART"}');
        ...
        $code1 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"KEJUTANGOMART"}');
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","Message: ".$message);
        goto gofood;
        ...
        $code1 = request2('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADI3GP"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","Message: ".$message);
        echo "\n".color("nevy","Vc4");
        echo "\n".color("yellow","Antosan Sakedap");
        ...
        sleep(5);
        $boba09 = request1('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADI3GP"}');
